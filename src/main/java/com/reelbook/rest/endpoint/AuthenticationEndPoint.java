...
public class AuthenticationEndPoint extends BaseEJB 
{
	...
	public Response signup(@ApiParam @FormParam("userName") String userName,
			@ApiParam @FormParam("firstName") String firstName, @ApiParam @FormParam("lastName") String lastName,
			@ApiParam @FormParam("email") String email, @ApiParam @FormParam("password") String password) {
		try {
